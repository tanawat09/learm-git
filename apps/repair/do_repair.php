...
try{
    ...
    if($result){
       ...
       // $msg = " ชื่อเครื่อง :".$req["inventory"] ." \nปัญหา :  ".$req["problem"] ."\nผู้แจ้ง " .$req["repairer"];
		//$msg .= "\nรายระเอียจปัญหา :" .$req["doc_status"];
...
/////////////////////////////////////////////////////////////////////////////
    ...
    $sToken = "Hgm9Pf4fuzsa4tUFnMQ40MEOOEFXnqXjbK5IWU4qx9L";

    $sMessage = "\r\n".'ชื่อเครื่อง : = '.$req["inventory"].
                "\r\n".' ปัญหา : = '.$req["problem"].
                "\r\n".'ผู้แจ้ง : = '.$req["repairer"].
                "\r\n".' รายระเอียจปัญหา : = '.$req["doc_status"];
